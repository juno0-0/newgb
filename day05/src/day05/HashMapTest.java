...
public class HashMapTest {
	public static void main(String[] args) {
		...
		//과일 평균 가격 출력
		int sum = 0;
		Iterator<Integer> fruitPrice = fruitMap.values().iterator();
		while(fruitPrice.hasNext()) {
			sum += fruitPrice.next();
		}
		double avg = sum/fruitMap.size();
		...
		double avg2 = Double.parseDouble(String.format("%.2f", (double)total/fruitMap.size()));
