...
//		});
		...
		if(datas.contains(20)) {
			...
			msg = "수정 실패 : 값을 찾지 못하였습니다.";
		}
		System.out.println(msg);
		
		//삭제 (50 삭제)
		if(datas.contains(new Integer(50))) { // 리턴이 boolean이라서 remove(index)를 사용하지 않음 
			datas.remove(new Integer(50));
			msg = "삭제 성공 : "+datas.toString();
		}else {
			msg = "삭제 실패 : 값을 찾지 못하였습니다.";
		}
		System.out.println(msg);
		...
		//마지막 10을 삭제한다.
		System.out.println(datas2.lastIndexOf(new Integer(10)));
