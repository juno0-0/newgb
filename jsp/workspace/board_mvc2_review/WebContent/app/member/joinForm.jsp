			...
			<center>
				<table border="1" cellpadding="0" cellspacing="0" width="25%">
					...
					<tr height="40px">
						...
						<td><input type="text" name="memberAge" style="width: 280px;"></td>
					</tr>
					<tr height="40px">
					...
					<tr height="40px">
						...
						<td>
							<input type="text" name="memberZipcode" class="postcodify_postcode5" style="width: 280px;" />
							<input type="button" id="postcodify_search_button" value="검색"><br>
						</td>
					</tr>
					<tr height="40px">
						<td align="center" width="100px">주소</td>
						<td><input type="text" name="memberAddress" class="postcodify_address" value="" style="width: 280px;" readonly/></td>
					</tr>
					<tr height="40px">
						<td align="center" width="100px">상세주소</td>
						<td><input type="text" name="memberAddressDetail" class="postcodify_details" value="" style="width: 280px;" /></td>
					</tr>
					<tr height="40px">
						<td align="center" width="100px">참고항목</td>
						<td><input type="text" name="memberAddressEtc" class="postcodify_extra_info" value="" style="width: 280px;" readonly/></td>
					</tr>
					<tr height="40px">
						<td colspan="2" align="center">
